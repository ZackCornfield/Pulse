      ...
      <div className="container mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0 mb-6">
          ...
          <div className="flex space-x-4 text-xs sm:text-base">
            <button
              className={`px-4 py-2 rounded-lg transition-colors ${activeTab === 'posts_all' ? 'bg-zinc-600 text-white' : 'bg-zinc-800 text-gray-400'} hover:bg-zinc-700`}
              onClick={() => setActiveTab('posts_all')}
            >
              All
            </button>
            <button
              className={`px-4 py-2 rounded-lg transition-colors ${activeTab === 'posts_following' ? 'bg-zinc-600 text-white' : 'bg-zinc-800 text-gray-400'} hover:bg-zinc-700`}
            ...
            <div className="border-l border-gray-700 mx-4 my-2"></div>
              <button onClick={() => navigate('/submit-post')}
                  className={`px-4 py-2 rounded-lg bg-gradient-to-br from-gray-600 to-gray-500`}
              >
